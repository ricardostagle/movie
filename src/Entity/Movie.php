...
/**
 * @file
 * Contains \Drupal\movie\Entity\Movie.
 */
 ...
 *   handlers = {
 *      "access" = "Drupal\movie\MovieAccessControlHandler",
 *      "views_data" = "Drupal\movie\MovieViewsData",
 *      "form" = {
...
class Movie extends EditorialContentEntityBase {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('User'))
      ->setDescription(t('The user that created the movie.'))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Movie entity is published.'))
